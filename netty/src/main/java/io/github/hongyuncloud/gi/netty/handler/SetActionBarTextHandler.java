...
public final class SetActionBarTextHandler implements IHandler {
  private static final @NotNull Logger logger = LoggerFactory.getLogger(SetActionBarTextHandler.class);
  private final @NotNull GiCoreOutboundNettyHandler nettyCore;
  private final @NotNull ChatHandler chatHandler;

  public SetActionBarTextHandler(final @NotNull GiCoreOutboundNettyHandler nettyCore) {
