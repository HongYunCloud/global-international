...
public final class SetTabListHeaderAndFooterHandle implements IHandler {
  private static final @NotNull Logger logger = LoggerFactory.getLogger(SetTabListHeaderAndFooterHandle.class);
  private final @NotNull GiCoreOutboundNettyHandler nettyCore;
  private final @NotNull ChatHandler chatHandler;

  public SetTabListHeaderAndFooterHandle(final @NotNull GiCoreOutboundNettyHandler nettyCore) {
