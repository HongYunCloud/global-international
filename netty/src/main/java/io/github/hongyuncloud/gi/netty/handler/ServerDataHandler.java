...
public final class ServerDataHandler implements IHandler {
  private static final @NotNull Logger logger = LoggerFactory.getLogger(ServerDataHandler.class);
  private final @NotNull GiCoreOutboundNettyHandler nettyCore;
  private final @NotNull ChatHandler chatHandler;

  public ServerDataHandler(final @NotNull GiCoreOutboundNettyHandler nettyCore) {
